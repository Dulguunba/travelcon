...
const RouteTours = ({ day, busIcon, planeIcon, startTime, endTime, startPoint, endPoint }: RouteToursProps) => {
    return (
        <div className='w-full bg-grayColor rounded-3xl h-[160px] pt-4 px-8'>
            ...
            <div className='w-full mt-14 border-dashed border-2 border-blue relative'>
                ...
                <div className='absolute bottom-3 -left-5 text-sm lg:text-base'>{startTime}</div>
                <div className='absolute -bottom-9 -left-5 text-sm lg:text-base'>{startPoint}</div>
                ...
                <div className='absolute bottom-3 -right-5 text-sm lg:text-base'>{endTime}</div>
                <div className='absolute -bottom-9 -right-5 text-sm lg:text-base'>{endPoint}</div>
