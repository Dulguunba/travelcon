...
const ReviewCard = ({ message, proPic, name }: Props) => {
    return (
        <div className='lg:w-[745px] w-full h-[300px] lg:h-[428px] rounded-3xl lg:p-16 p-6 font-primary shadow-xl flex flex-col justify-between'>
            ...
            <div className='flex gap-5 items-center'>
                <div className='overflow-hidden lg:w-20 lg:h-20 rounded-full'> <img src={proPic} alt="Profile Image" className='w-full h-full' /></div>
