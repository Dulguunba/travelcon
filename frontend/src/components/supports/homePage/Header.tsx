...
const Header = ({
  ...
  return (
    <>
        ...
        <div className="flex max-w-[1520px] w-[90%] z-10">
          ...
          >
            ...
            <div className="hidden lg:flex gap-14 lg:items-center lg:drop-shadow-lg">
              ...
              <Link href={"/about"}>
                <p className="cursor-pointer hover:-translate-y-1 transition ease-in-out">
                  About
                </p>
              </Link>
              {user && (
                <Link href={`dashboard/${user.sid}`}>
                  <p className="cursor-pointer hover:-translate-y-1 transition ease-in-out">
                    Dashboard
                  </p>
                </Link>
              ...
              <>
                <div className="flex gap-6 items-center">
                  <a
                    ...
                    className="hidden lg:block p-3 border rounded-lg font-medium cursor-pointer hover:-translate-y-1 transition ease-in-out hover:scale-110"
                  >
                    Log Out
                  </a>
                </div>
      ...
      <div
        className="fixed right-0 left-auto top-0 z-50 transition-all bg-slate-900 text-white w-[200px] h-screen duration-500 ease-in-out"
        style={{
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <ul className="ml-2 mr-2 mt-10 font-primary flex flex-col gap-6">
            <Link className="w-full  text-xl font-semibold" href={"/"}>
              <li>Home</li>
            </Link>
            <Link
