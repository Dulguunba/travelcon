        ...
        <div className=' bg-white rounded-lg p-5'>
            ...
            <div className=' w-full flex gap-5 my-5'>
                <div className=' flex flex-col w-6/12'>
                    ...
                    <label className='text-black text-lg'>Date of Birth</label>
                    <input type="date" className='rounded p-2 bg-white border border-gray-300 mb-3' onChange={(e)=>setUserData({...userData,date:e.target.value})}/>
                </div>
                <div className=' flex flex-col w-6/12'>
