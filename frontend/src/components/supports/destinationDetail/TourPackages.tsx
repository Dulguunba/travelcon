                ...
                {travelDatas.result.map((data) => (
                    data.destination.english === destination
                        ...
                        <Link href={`/tours/${data._id}`}>
                            <TourPackageCard image={data.image.mainImage} title={data.name} time={data.duration} destinationName={destination} startPrice={data.price.adultPrice} duration={data.duration} />
                        </Link>
                        : null
                ))}
