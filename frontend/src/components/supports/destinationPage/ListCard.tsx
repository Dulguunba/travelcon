                ...
                <div key={index} className='md:flex  rounded-xl  justify-between w-full gap-12'>
                    ...
                    <div className='flex flex-col justify-end w-[100%] lg:w-[25%]'>
                        <div className='flex items-center gap-4'>
                            <Time />
                            <h3 className='font-normal text-[20px] leading-[30px]  text-[#222222]'>{item.duration} Days</h3>
                        </div>
                        <div className='flex items-center gap-4 pt-4'>
                            <DollarBlack />
                            <h3 className='font-normal text-[20px] leading-[30px]  text-[#222222]'>Start from ₮{item.price.adultPrice}</h3>
                        </div>
