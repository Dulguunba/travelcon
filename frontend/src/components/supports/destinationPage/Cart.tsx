...
export const Cart = ({ travelDatas, toursData, destinationDatas, categoryDatas }: Props) => {
    const LearnMore = () => {
                ...
                <div className='flex max-w-[1520px] w-[90%] py-5 flex-col border border-gray-400 rounded-3xl p-4  '>
                    ...
                    <div className='flex flex-col justify-end w-[100%] lg:w-[25%]'>
                        <div className='flex items-center gap-4 pt-4 flex-col'>
                            <h3 className='font-normal text-[20px] leading-[30px]  text-[#222222]'>Total : 10000</h3>
                            <button className=' cursor-pointer hover:-translate-y-1 transition ease-in-out rounded-[10px] bg-[green] text-white font-medium text-[20px] leading-[30px] py-4 px-8'>Checkout</button>
                        </div>
                    </div>
                </div>
