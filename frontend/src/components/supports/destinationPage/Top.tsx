...
const Top = ({ travelDatas, toursData, destinationDatas, categoryDatas }: FetchDataProps) => {
  return (
    <>
            ...
            <div>
                <div className='flex flex-col items-center'>
                    <div className='flex flex-col items-center drop-shadow-md'>
                        ...
                        <h1 className='font-oswald drop-shadow-md font-bold lg:text-[200px] xl:text-[200px] text-[50px] text-white '>TOURS</h1>
                    </div>
