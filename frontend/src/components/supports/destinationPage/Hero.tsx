                    ...
                    <div className="flex justify-between w-full items-center flex-wrap">
                        ...
                        {grid == "grid" ? (
                            <div className=" md:grid md:grid-cols-3  md:grid-rows-4 md:h-full flex flex-col  w-full pt-20 gap-[30px] ">
                                <Card travelDatas={travelDatas} toursData={toursData} destinationDatas={destinationDatas} categoryDatas={categoryDatas} state={selectedCategory}
                                />
                            </div>
                        ) : (
                            <div className=" flex flex-col w-full py-20 gap-12 ">
                                <ListCard travelDatas={travelDatas} toursData={toursData} destinationDatas={destinationDatas} categoryDatas={categoryDatas} state={selectedCategory}
                                />
                            </div>
                        )}
                    </div>
